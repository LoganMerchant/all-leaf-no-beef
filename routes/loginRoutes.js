...
const mailjet = require("node-mailjet").connect(
  "bda99ebd366ba03786334b07d6ac9294",
  "82adec7caa9428fd0c3579c64d26cac6"
);
...
exports.register = function (req, res) {
  ...
  if (
    ...
    res.send({
      failed:
        " You must insert valid password. Password must be at least 8 characters long",
    });
  }
};
              ...
              Messages: [
                {
                  ...
                  HTMLPart:
                    ...
                    ", You need to reset your password for forum! </h3><br />May the delivery force be with you!",
